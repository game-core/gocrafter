...
//
//go:generate mockgen -source=./master_login_bonus_item_repository.gen.go -destination=./master_login_bonus_item_repository_mock.gen.go -package=masterLoginBonusItem
...
type MasterLoginBonusItemRepository interface {
	...
	FinOrNilByMasterLoginBonusScheduleId(ctx context.Context, masterLoginBonusScheduleId int64) (*MasterLoginBonusItem, error)
	FinOrNilByMasterItemId(ctx context.Context, masterItemId int64) (*MasterLoginBonusItem, error)
	FinOrNilByMasterLoginBonusScheduleIdAndMasterItemId(ctx context.Context, masterLoginBonusScheduleId int64, masterItemId int64) (*MasterLoginBonusItem, error)
