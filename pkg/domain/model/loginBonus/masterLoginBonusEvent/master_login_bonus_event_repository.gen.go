...
//
//go:generate mockgen -source=./master_login_bonus_event_repository.gen.go -destination=./master_login_bonus_event_repository_mock.gen.go -package=masterLoginBonusEvent
