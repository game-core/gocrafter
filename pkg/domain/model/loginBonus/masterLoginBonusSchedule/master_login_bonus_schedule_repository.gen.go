...
//
//go:generate mockgen -source=./master_login_bonus_schedule_repository.gen.go -destination=./master_login_bonus_schedule_repository_mock.gen.go -package=masterLoginBonusSchedule
...
type MasterLoginBonusScheduleRepository interface {
	...
	FinOrNilByMasterLoginBonusId(ctx context.Context, masterLoginBonusId int64) (*MasterLoginBonusSchedule, error)
	FinOrNilByStep(ctx context.Context, step int32) (*MasterLoginBonusSchedule, error)
	FinOrNilByMasterLoginBonusIdAndStep(ctx context.Context, masterLoginBonusId int64, step int32) (*MasterLoginBonusSchedule, error)
