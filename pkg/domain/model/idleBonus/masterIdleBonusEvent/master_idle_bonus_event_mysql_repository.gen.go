...
//
//go:generate mockgen -source=./master_idle_bonus_event_mysql_repository.gen.go -destination=./master_idle_bonus_event_mysql_repository_mock.gen.go -package=masterIdleBonusEvent
...
type MasterIdleBonusEventMysqlRepository interface {
