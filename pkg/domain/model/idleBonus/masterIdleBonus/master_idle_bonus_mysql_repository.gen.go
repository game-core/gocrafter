...
//
//go:generate mockgen -source=./master_idle_bonus_mysql_repository.gen.go -destination=./master_idle_bonus_mysql_repository_mock.gen.go -package=masterIdleBonus
...
type MasterIdleBonusMysqlRepository interface {
