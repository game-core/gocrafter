...
//
//go:generate mockgen -source=./master_idle_bonus_schedule_repository.gen.go -destination=./master_idle_bonus_schedule_repository_mock.gen.go -package=masterIdleBonusSchedule
...
type MasterIdleBonusScheduleRepository interface {
	...
	FinOrNilByMasterIdleBonusId(ctx context.Context, masterIdleBonusId int64) (*MasterIdleBonusSchedule, error)
	FinOrNilByStep(ctx context.Context, step int32) (*MasterIdleBonusSchedule, error)
	FinOrNilByMasterIdleBonusIdAndStep(ctx context.Context, masterIdleBonusId int64, step int32) (*MasterIdleBonusSchedule, error)
