...
//
//go:generate mockgen -source=./master_idle_bonus_item_repository.gen.go -destination=./master_idle_bonus_item_repository_mock.gen.go -package=masterIdleBonusItem
...
type MasterIdleBonusItemRepository interface {
	...
	FinOrNilByMasterIdleBonusScheduleId(ctx context.Context, masterIdleBonusScheduleId int64) (*MasterIdleBonusItem, error)
	FinOrNilByMasterItemId(ctx context.Context, masterItemId int64) (*MasterIdleBonusItem, error)
	FinOrNilByMasterIdleBonusScheduleIdAndMasterItemId(ctx context.Context, masterIdleBonusScheduleId int64, masterItemId int64) (*MasterIdleBonusItem, error)
