...
type UserIdleBonusRepository interface {
	...
	FindByMasterIdleBonusIdAndUserId(ctx context.Context, userId string, masterIdleBonusId int64) (*UserIdleBonus, error)
	FinOrNilByUserId(ctx context.Context, userId string) (*UserIdleBonus, error)
	FinOrNilByMasterIdleBonusIdAndUserId(ctx context.Context, userId string, masterIdleBonusId int64) (*UserIdleBonus, error)
	...
	FindListByMasterIdleBonusIdAndUserId(ctx context.Context, userId string, masterIdleBonusId int64) (UserIdleBonuses, error)
