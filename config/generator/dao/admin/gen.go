...
import (
	...
	"github.com/game-core/gocrafter/domain/entity/admin/{{.Package}}"
	{{.Package}}Repository "github.com/game-core/gocrafter/domain/repository/admin/{{.Package}}"
)
...
func main() {
	outputBaseDir := "../../../../infra/dao/admin"
	yamlFiles, err := filepath.Glob("../../../../docs/entity/admin/*.yaml")
	if err != nil {
