...
import (
	...
	"github.com/game-core/gocrafter/domain/entity/auth/{{.Package}}"
	{{.Package}}Repository "github.com/game-core/gocrafter/domain/repository/auth/{{.Package}}"
)
